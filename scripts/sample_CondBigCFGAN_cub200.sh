...
--dataset CUB200 --parallel --shuffle  --num_workers 8 --batch_size 64 \
--num_G_accumulations 1 --num_D_accumulations 1 \
--num_D_steps 4 --G_lr 1e-4 --D_lr  1e-4 --D_B2 0.999 --G_B2 0.999 \
--G_attn 0 --D_attn 0 \
